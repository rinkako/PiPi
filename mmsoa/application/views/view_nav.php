	                    ...
	                    if ($_SESSION['level'] >= 1) { echo 
		                    '<li id="active-workReview">' . 
		                        ...
		                        '<ul class="nav nav-second-level">' . 
		                            ...
		                            '</li>' . 
		                            '<li id="active-weeklyReview"><a href="'. site_url('Backend/weeklyReview') . '">周检</a>' . 
		                            '</li>' . 
		                            '<li id="active-dutyReview"><a href="'. site_url('Backend/dutyReview') . '">值班</a>' . 
		                            '</li>' . 
		                        '</ul>' . 
		                    '</li>';
	                    } 
	                    ...
	                    if ($_SESSION['level'] >= 1) { echo 
		                    '<li id="active-journal">' . 
		                        ...
		                        '<ul class="nav nav-second-level">' . 
		                            ...
		                            '</li>' . 
		                            '<li id="active-readJournal"><a href="'. site_url('Backend/readJournal') . '">查看</a>' . 
		                            '</li>' . 
		                        '</ul>' . 
		                    '</li>';
	                    } 
	                    ...
	                    if ($_SESSION['level'] >= 3) { echo 
		                    '<li id="active-userManagement">' . 
		                        ...
		                        '<ul class="nav nav-second-level">' . 
		                            ...
		                            '</li>' . 
		                            '<li id="active-searchUser"><a href="'. site_url('Backend/searchUser') . '">通讯录</a>' . 
		                            '</li>' . 
		                        '</ul>' . 
		                    '</li>';
	                    } else { echo 
	                    ...
	                    if ($_SESSION['level'] == 2 || $_SESSION['level'] == 3 || $_SESSION['level'] == 6) { echo 
		                    '<li id="active-timeStatistics">' . 
		                        ...
		                        '<ul class="nav nav-second-level">' . 
		                            ...
		                            '</li>' . 
		                            '<li id="active-allmembers"><a href="'. site_url('Backend/allWorkingTime') . '">全员</a>' . 
		                            '</li>' . 
		                        '</ul>' . 
		                    '</li>';
	                    } else if ($_SESSION['level'] == 0 || $_SESSION['level'] == 1) { echo
		                    '<li id="active-timeStatistics">' .
		                    	'<a href="'. site_url('Backend/perWorkingTime') . '"><i class="fa fa-rmb"></i> <span class="nav-label"> &nbsp;我的工时</span></a>' .
		                    '</li>';
	                    } else if ($_SESSION['level'] == 5) { echo
		                    '<li id="active-timeStatistics">' .
		                    	'<a href="'. site_url('Backend/allWorkingTime') . '"><i class="fa fa-rmb"></i> <span class="nav-label"> &nbsp;工时统计</span></a>' .
		                    '</li>';
	                    } 
                    ?>
