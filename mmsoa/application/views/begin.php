...
<body>
  ...
  <div class="logo">
	...
	<header id="head">
		<div class="container">
             <div class="heading-text">							
							<h1 class="animated flipInY delay1">Falling Behind Google</h1>
    ...
    <section class="main-contents">
      <h2 class="text-center sub-texts">One mission. Help your business reach peak profits.</h2>
      <div class="container">
      <hr>
         <div class="item-section col-md-4 col-sm-4 col-xs-12">
            <ul>
              <li class="inline-text">
                <i class="fa fa-star"></i><p class="icon-text">A visit back to The Vedas</p>
              </li>
              <li class="inline-text">
                <i class="fa fa-star"></i><p class="icon-text">A visit back to The Vedas</p>
              </li> 
  ...
  <footer>
    ...
    <div class="footer-bottom">
      <div class="container">
        <div class="social pull-left">
          <p>Designed by Theme Wagon Advisors | More Templates <a href="http://www.cssmoban.com/" target="_blank" title="模板之家">模板之家</a> - Collect from <a href="http://www.cssmoban.com/" title="网页模板" target="_blank">网页模板</a></p>
        </div>
        <div class="navigation">
          <ul class="pull-right">
